...
public class VMIntrospectorImpl implements VMIntrospector {
    ...
    public VMIntrospectorImpl() {
        Logger.getLogger("payara-javaee").log(Level.FINE, "VMIntrospector created"); // NOI18N
    }
    ...
    public boolean isSuspended(String host, String port) {
        Logger.getLogger("payara-javaee").log(Level.FINE, "VMIntrospector called {0}, {1}", new Object[] { host, port }); // NOI18N
