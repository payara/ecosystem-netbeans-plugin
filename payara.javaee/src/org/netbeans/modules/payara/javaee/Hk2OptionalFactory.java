...
import org.netbeans.modules.payara.javaee.db.Hk2DatasourceManager;
import org.netbeans.modules.payara.javaee.ide.FastDeploy;
...
//    }
    ...
    public FindJSPServlet getFindJSPServlet(DeploymentManager dm) {
        ...
        try {
            ...
            Logger.getLogger("payara-javaee").log(Level.FINER, "caller passed invalid param", cce); // NOI18N
        }
        return retVal;
    }
    ...
    public ServerInstanceDescriptor getServerInstanceDescriptor(DeploymentManager dm) {
        ...
        if(dm instanceof Hk2DeploymentManager) {
            ...
            Logger.getLogger("payara-javaee").log(Level.WARNING, "Invalid deployment manager: {0}", dm); // NOI18N
        }
        return result;
    }
                ...
                if(obj instanceof ServerInstance) {
                    ...
                    if (lookup != null) {
                        ...
                        if(module != null) {
                            ...
                            Logger.getLogger("payara-javaee").log(Level.WARNING,"No JavaEE facade found for {0}", instance.getDisplayName()); // NOI18N
                        }
                    } else {
                        Logger.getLogger("payara-javaee").log(Level.WARNING, "No lookup found for {0}", instance.getDisplayName()); // NOI18N
                    }
                } else {
