...
import org.netbeans.modules.payara.javaee.ide.DummyProgressObject;
import org.netbeans.modules.payara.javaee.ide.Hk2PluginProperties;
import org.netbeans.modules.payara.javaee.ide.Hk2Target;
import org.netbeans.modules.payara.javaee.ide.Hk2TargetModuleID;
import org.netbeans.modules.payara.javaee.ide.MonitorProgressObject;
import org.netbeans.modules.payara.javaee.ide.UpdateContextRoot;
...
public class Hk2DeploymentManager implements DeploymentManager2 {
    ...
    public Target[] getTargets() throws IllegalStateException {
        ...
        if (null == ip) {
            Logger.getLogger("payara-javaee").log(Level.INFO, "instance props are null for URI: "+getUri(), new Exception());
    ...
    public ServerInstance getServerInstance() {
        ...
        if ((serverInstance = su.getServerInstance(uri)) == null) {
            ...
            Logger.getLogger("payara-javaee").log(Level.WARNING, warning);
