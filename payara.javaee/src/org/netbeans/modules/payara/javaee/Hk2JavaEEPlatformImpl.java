...
public class Hk2JavaEEPlatformImpl extends J2eePlatformImpl2 {
    ...
    private void addFcl() {
        if (null == fcl) {
            ...
            if (null == fo) {
                Logger.getLogger("payara-javaee").log(Level.WARNING, "{0} did not exist but should", f.getAbsolutePath());
                return;
            }
    ...
    public File[] getToolClasspathEntries(String toolName) {
        ...
        if (null != gfRootStr) {
            ...
            Logger.getLogger("payara-javaee").log(Level.INFO, "dm has no root???", new Exception());
        }
     ...
     */
    private PayaraVersion getGFVersion() {
    ...
    private String getAccConfigFile() {
        final PayaraVersion version = getGFVersion();
    ...
    private class JaxRsStackSupportImpl implements JaxRsStackSupportImplementation {
        ...
        public boolean addJsr311Api(final Project project) {
            ...
            try {
                ...
                else if (version.equalsMajorMinor(PayaraVersion.GF_3)) {
                    final File jsr311 = ServerUtilities.getJarName(dm.getProperties()
                            .getPayaraRoot(), "jsr311-api.jar"); // NOI18N
                ...
                else if (version.equalsMajorMinor(PayaraVersion.GF_3_1)) {
                    final File jerseyCore = ServerUtilities.getJarName(dm.getProperties().
                            getPayaraRoot(), "jersey-core.jar"); // NOI18N
