 ...
 * Covers GlassFish servers before 3.1. Old {@code sun-resources.xml} files are
 * used.
 * <p/>
...
public class Hk2Configuration extends PayaraConfiguration implements DeploymentConfiguration {
    ...
    /**
     * Creates an instance of Java EE server configuration API support for
     * GlassFish servers before 3.1.
     * <p/>
     * @param module Java EE module (project).
     * @param version Payara server version.
     * @throws ConfigurationException when there is a problem with Java EE
    ...
    /**
     * Creates an instance of Java EE server configuration API support for
     * GlassFish servers before 3.1 with existing {@link J2eeModuleHelper}
     * instance.
     * <p/>
     * @param module Java EE module (project).
    ...
    public MessageDestination createMessageDestination(String name, MessageDestination.Type type) throws UnsupportedOperationException, org.netbeans.modules.j2ee.deployment.common.api.ConfigurationException {
        ...
        if (resourceDir == null) {
            Logger.getLogger("payara-javaee").log(Level.WARNING, "Resource Folder {0} does not exist.", resourceDir);
