...
public class DomainEditor {
    ...
    private boolean isPayaraV1OrV2;

    /**
     * Creates a new instance of DomainEditor
     * @param dm Deployment Manager of Target Server
     */
    public DomainEditor(String domainLocation, String domainName, boolean isPayaraV1OrV2) {
        this.dmLoc = domainLocation;
        this.dmName = domainName;
        this.isPayaraV1OrV2 = isPayaraV1OrV2;
    }
   ...
   //         boolean usingNativeLauncher = false;
            ...
            if ((osType.startsWith("Mac OS"))||isPayaraV1OrV2){//no native for mac of glassfish
