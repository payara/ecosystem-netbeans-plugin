...
public class VersionRepository {
    ...
    private final List<MicroVersion> microVersions = new ArrayList<>();

    private VersionRepository() {
        microVersions.add(new MicroVersion("5.Beta2", "8.0"));
        microVersions.add(new MicroVersion("4.1.2.181", "7.0"));
        microVersions.add(new MicroVersion("4.1.2.174", "7.0"));
    }
    ...
    public Set<String> getPayaraMicroVersion() {
        return microVersions.stream()
                .map(micro -> micro.getVersion())
                .collect(toSet());
    }
